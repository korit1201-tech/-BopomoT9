...
- ✍️ **高精度離線手寫模式（Offline Handwriting Recognition）**：
  - 空白鍵左右滑動自由輪替「繁」→「簡」→「手」。
  - 內建 8,000+ 常用繁體漢字筆順庫，結合五筆筆畫特徵提取（橫 1、豎 2、撇 3、捺點 4、折 5）。
  - 自動偵測幾何轉折角（折）、封閉環形（0/O/口）與軌跡特徵。
  - 動態 Levenshtein 編輯距離模糊比對結合在地字頻權重，手寫識別率大幅提升，且 100% 離線毫秒級響應。
